<footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-links">
            <h4>Our Services</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Mobile App UI Design</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Mobile App Development</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Web UI Design</a></li>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Nsgr Development</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
